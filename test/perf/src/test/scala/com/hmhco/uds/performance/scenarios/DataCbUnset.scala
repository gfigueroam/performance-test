...
case object DataCbUnSet extends BaseScenario {
  val description: String = "data.cb.unset"
  val method: String = "api/v1/data.cb.unset"
  ...
  def scenario = exec(
    exec{
      session =>
        ...
        val tmpQuery = loadJSON("data.cb.unset",rmap)
